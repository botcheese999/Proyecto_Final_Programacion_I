...
public:
    ...
    // Complejidad O(n): recorre desde el frente hasta el final evaluando
    // pred, sin desencolar. Uso previsto: verificaciones de pertenencia
    // simetricas a ColaPrioridad::existe().
