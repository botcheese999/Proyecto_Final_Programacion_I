...
public:
    ...
    // Complejidad O(n): aplica 'accion' (lambda o functor que recibe const T&)
    // a cada elemento en orden. Permite iterar desde fuera sin exponer Nodo<T>.
    // Uso previsto: listarEstudiantes/listarCursos y, en Fase 3, exportacion a CSV.
